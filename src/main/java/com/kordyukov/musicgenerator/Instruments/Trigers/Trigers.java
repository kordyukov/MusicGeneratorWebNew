...
public class Trigers implements Musician {
    ...
    private int[] tempSnare = IntStream.of(325, 650, 975).toArray();
    private int[] tempHat = IntStream.of(162, 325, 650,81, 40, 20).toArray();
    ...
    public int tempoTrigerHat() {
        ...
        tempoHat = !check ? tempHat[(0 + (int) (Math.random() * 5))] : tempHat[(0 + (int) (Math.random() * 2))];
